...
@Component({
  selector: 'app-alert-message-withsolid',
  templateUrl: './alert-message-withsolid.component.html',
  styleUrls: ['./alert-message-withsolid.component.css']
})
export class AlertMessageWithsolidComponent {
  alerts: Alert[] = [];
